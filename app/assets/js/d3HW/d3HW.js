...
d3.json("https://tranquil-peak-82564.herokuapp.com/api/v1.0/data/iris/", function(remote_json) {
  ...
  var sepal_length_chart = dc
    .barChart("#sepal_length_chart", "default")
    .width(250)
    .height(200)
  ...
  var species_chart = dc
    .barChart("#species_chart", "default")
    .width(250)
    .height(200)
    .dimension(species)
    .group(species_sum)
  ...
  var sepal_width_chart = dc
    .barChart("#sepal_width_chart", "default")
    .width(250)
    .height(200)
  ...
  sepal_width_chart.colors(d3.scale.category20b());

  var petal_length_chart = dc
    .barChart("#petal_length_chart", "default")
    .width(250)
    .height(200)
  ...
  var petal_width_chart = dc
    .barChart("#petal_width_chart", "default")
    .width(250)
    .height(200)
    ...
    if (species_chart.filters().length > 0 ||
      ...
      d3.select("#resetButton")
        ...
        .on("click", function() {
          ...
          dc.redrawAll("default");
          dc.redrawAll("petalGroup")
        });
